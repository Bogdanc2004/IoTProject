    ...
    try:
        ...
        if temp is not None and hum is not None:
            ...
            if ai_decision == 1:  
                ...
                time.sleep(300) # Sleep for 5 minutes (300 seconds) so the AI doesn't double-water
                continue # Skips the standard 3-second sleep below and restarts the loop fresh
